(function(){
  ...
  function is404(){return /\/404\.html$/.test(location.pathname||'');}
  function isPublic(){return is404()||location.pathname==='/'||/\/seo-lead-dashboard-site\/?$/.test(location.pathname)||PUBLIC_RE.test(location.pathname||'');}
