(function(){
  ...
  function planInfo(){
    ...
    if(!active)raw='free';
    var key=/stack|bundle|combined|multi/.test(raw)?'stacked':/growth/.test(raw)?'growth':/starter/.test(raw)?'starter':/admin|unlimited/.test(raw)?'admin':'free';
