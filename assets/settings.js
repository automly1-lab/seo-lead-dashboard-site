(function(){
  ...
  function render(){
    ...
    var pending=billing==='pending';var pendingBox=byId('pendingWarning');if(pendingBox)pendingBox.hidden=!pending;var cta=byId('planCta');if(cta){cta.hidden=admin;cta.textContent=meta.cta;cta.href=meta.href;}
